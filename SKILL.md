...
- 杂志绿 H2 简化为「01 标题」，不加竖线、PART、英文副标题；AGI绿 H2 用栈式大编号（48px 斜体编号 / 可选 10px 英文标签 / 20px 黑粗标题 / 标题下 1px 灰色收尾横线），只有原文或作者给出英文栏目名时才写 `label`，没有就省略整行标签，不自行编造。收尾横线是 AGI绿 专属，另外三套主题不加。杂志封面/目录文案来自原文或用户授权创作，不强制凑四节、不要编造摘要数据。Pro蓝则保留独立数字徽章与居中蓝色斜体章节风格。正文配图统一 10px 圆角 + 极淡投影，四套主题一致。
